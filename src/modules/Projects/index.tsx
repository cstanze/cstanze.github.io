...
export const Projects = () => {
  ...
  return (
    <div 
      className="App-mainLeftBottom flex flex-col text-center justify-around overflow-scroll max-h-44 shadow-gray-500 md:shadow-none shadow-inner md:max-h-full"
